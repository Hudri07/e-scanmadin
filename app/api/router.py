...
from app.api.endpoints import auth, profile, koreksi, views, siswa, pdf, excel, master_kunci
...
api_router.include_router(master_kunci.router, prefix="/kunci", tags=["Master Kunci"])
